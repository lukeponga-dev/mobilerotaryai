...
const AdBanner: React.FC = () => {
  ...
  return (
    <footer 
      className="flex-shrink-0 bg-light-surface dark:bg-dark-surface border-t border-light-border dark:border-dark-border items-center justify-center hidden md:flex"
