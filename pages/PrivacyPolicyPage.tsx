  ...
  return (
    <div className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto scroll-smooth bg-light-surface dark:bg-dark-surface">
      <div className="max-w-3xl mx-auto text-light-text dark:text-dark-text">
        ...
        <ul className="list-disc list-inside mb-4 space-y-2 text-light-muted dark:text-dark-muted">
        ...
        <h2 className="text-2xl font-semibold text-light-text dark:text-dark-text mt-8 mb-4">How We Use Your Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-light-text dark:text-dark-text mt-8 mb-4">Data Storage and Security</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-light-text dark:text-dark-text mt-8 mb-4">Third-Party Services</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-light-text dark:text-dark-text mt-8 mb-4">Changes to This Privacy Policy</h2>
        <p className="mb-4">
          We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page. You are advised to review this Privacy Policy periodically for any changes.
        </p>

        <h2 className="text-2xl font-semibold text-light-text dark:text-dark-text mt-8 mb-4">Contact Us</h2>
        <p className="mb-4">
