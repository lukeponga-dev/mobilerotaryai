      ...
      <div className="flex-1 p-6 md:p-8 overflow-y-auto scroll-smooth">
        ...
        <div className="text-center py-12 md:py-16">
          ...
          <Button
            ...
            size="lg"
            className="group gap-3 bg-gradient-to-br from-rose-600 to-rose-700 shadow-lg hover:shadow-2xl hover:shadow-rose-600/40"
          >
                ...
                {recentSessions.map(session => (
                  <li key={session.id}>
                    <a 
                      ...
                      className="block p-3 bg-white dark:bg-slate-700/50 rounded-md transition-all duration-300 hover:shadow-lg hover:ring-2 hover:ring-rose-500/50 hover:-translate-y-0.5"
                    >
             ...
             <ul className="space-y-2">
                {quickLinks.map(link => (
                  <li key={link.title}>
                    <a 
                      href={link.href} 
                      className="block p-2.5 text-sm font-medium text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-700/50 rounded-md transition-all duration-200 hover:bg-slate-200/60 dark:hover:bg-slate-700 hover:text-rose-500"
                    >
                      {link.title}
                    </a>
                  </li>
