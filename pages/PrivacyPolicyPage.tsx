...
const PrivacyPolicyPage: React.FC<PrivacyPolicyPageProps> = ({ onToggleSidebar }) => {
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-slate-900">
      ...
      <div className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto">
        <div className="max-w-3xl mx-auto text-slate-300">
          <h1 className="text-3xl font-bold text-white mb-6">Privacy Policy for RotorWise AI</h1>
